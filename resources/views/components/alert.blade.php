...
<!-- alert -->
<div class="w-full flex items-center px-6 py-3 mb-4 text-base text-{{$alertColor}}-800 border border-{{$alertColor}}-300 rounded-lg bg-{{$alertColor}}-100" role="alert" id="alert">
